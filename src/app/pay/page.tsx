        ...
        <div className="w-full space-y-4">
          ...
          >
            {venmoInitiated ? (
              ...
              <>
                <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M21.2 14.6c-.7-1.2-1.4-2.4-2.1-3.6-.7-1.2-1.4-2.4-2.1-3.6-.7-1.2-1.4-2.4-2.1-3.6-.3-.5-.6-.8-1.2-.8-.6 0-.9.3-1.2.8-.7 1.2-1.4 2.4-2.1 3.6-.7 1.2-1.4 2.4-2.1 3.6-.7 1.2-1.4 2.4-2.1 3.6-.3.5-.3 1 .2 1.4.5.4 1 .3 1.4-.2.7-1.2 1.4-2.4 2.1-3.6.7-1.2 1.4-2.4 2.1-3.6.7-1.2 1.4-2.4 2.1-3.6.3-.5.6-.8 1.2-.8.6 0 .9.3 1.2.8.7 1.2 1.4 2.4 2.1 3.6.7 1.2 1.4 2.4 2.1 3.6.7 1.2 1.4 2.4 2.1 3.6.3.5.3 1-.2 1.4-.5.4-1 .3-1.4-.2z"/>
                </svg>
